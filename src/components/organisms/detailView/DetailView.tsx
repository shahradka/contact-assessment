...
const DetailView = ({first_name, last_name, avatar, phone, email, gender, address, telegram, company, note}:CONTACT_TYPE) => {
    ...
    return <div className="detail-view">
            ...
            <div className={classNames(["grid-span-sm-col--3", "detail-view-person-info"])}>
                <Text componentType="h2" variant="heading3" >
        ...
        <hr />
        <div className="more-details-info grid grid-sm-col--2 grid-lg-col--4">
            <Text color="gray" componentType="div">
                Gender
            </Text>
            <Text componentType="div">
                {gender}
            ...
            <Text color="gray" className="grid-span-sm-col--2 grid-span-lg-col--4 detail-view-text" componentType="div">
                Note
            </Text>
